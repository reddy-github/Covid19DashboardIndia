    ...
    return (
      <>
        <div testid="countryWideConfirmedCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/saicharan/image/upload/v1642328451/Group_em1qas.png"
        ...
        <div testid="countryWideActiveCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/saicharan/image/upload/v1642329964/protection_1_xjzema.png"
            className="stats-icon"
        ...
        <div testid="countryWideRecoveredCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/saicharan/image/upload/v1642329964/recovered_1_sgqgd4.png"
            className="stats-icon"
        ...
        <div testid="countryWideDeceasedCases" className="stats-block-column ">
          ...
          <img
            src="https://res.cloudinary.com/saicharan/image/upload/v1642329964/Corona_Virus_Symptoms_Shortness_of_breath_oqihj9.png"
            className="stats-icon"
