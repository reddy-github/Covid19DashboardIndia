...
class StateTotalData extends Component {
  ...
  getEachState = async () => {
    ...
    const confirmedData = {
      name: 'Confirmed',
      logo:
        'https://res.cloudinary.com/saicharan/image/upload/v1642328451/Group_em1qas.png',
    ...
    const activeData = {
      name: 'Active',
      logo:
        'https://res.cloudinary.com/saicharan/image/upload/v1642329964/protection_1_xjzema.png',
      value: totalActive,
    }
    ...
    const recoveredData = {
      name: 'Recovered',
      logo:
        'https://res.cloudinary.com/saicharan/image/upload/v1642329964/recovered_1_sgqgd4.png',
      value: totalRecovered,
    }
    const deceasedData = {
      name: 'Deceased',
      logo:
        'https://res.cloudinary.com/saicharan/image/upload/v1642329964/Corona_Virus_Symptoms_Shortness_of_breath_oqihj9.png',
      value: totalDeceased,
    }
